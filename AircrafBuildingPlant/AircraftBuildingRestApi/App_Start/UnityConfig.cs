...
namespace AircraftBuildingRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, AircraftDbContext>(new
HierarchicalLifetimeManager());
           ...
           HierarchicalLifetimeManager());
            container.RegisterType<IWarehouseService, WarehouseServiceDB>(new
           HierarchicalLifetimeManager());
            container.RegisterType<IMainService, MainServiceDB>(new
           HierarchicalLifetimeManager());
            container.RegisterType<IReplayService, ReplayServiceDB>(new
           HierarchicalLifetimeManager());
        }
    }
}